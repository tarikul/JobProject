				...
				<div class="row">
					...
					<div id="custom_right" class="col-md-9">
						...
						<div class="form-group">
							...
							<input type="text" name="job_title" class="form-control" value="" id="job_title" required>
						</div>
						<fieldset disabled>
						<div class="form-group">
							<label for="">Company Name</label>
							<input type="text" name="com_name" class="form-control" value="<?php echo $com_name?>" required id="com_name">
						</div>
						</fieldset>
						<div class="form-group">
							<label for="">No. of Vacancies</label>
							<input type="text" name="no_vacancie" class="form-control" required value="" id="no_vacancie">
						</div>
						<div class="form-group">
							<label for="">Job Description / Responsibility</label>
							<textarea class="form-control" rows="3" name="job_description" required id="job_description"></textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="2" name="edu_requirement" required id="edu_requirement"></textarea>
						</div>
						<div class="form-group">
							<label for="">Experience Requirements</label>
							<textarea class="form-control" rows="2" name="exp_requirement" required id="exp_requirement"></textarea>
						</div>
						<div class="form-group">
							<label for="">Additional Job Requirements</label>
							<textarea class="form-control" rows="2" name="job_requirement" required id="job_requirement"></textarea>
						</div>
						<div class="form-group">
							<label for="">Job Location</label>
							<input type="text" name="job_location" class="form-control" required value="" id="job_location">
						</div>
						<div class="form-group">
							<label for="">Salary Range</label>
							<input type="text" name="salary" class="form-control"  required value="" id="salary">
						</div>
						<div class="form-group">
							<label for="">Other Benfits</label>
							<input type="text" name="benfit" class="form-control" required value="" id="benfit">
						</div>
						<div class="form-group">
							<label for="">Application Deadline</label>
							<div class="input-append date"  data-date="" data-date-format="dd-mm-yyyy">
								<input id="dob" name="dob" required placeholder="choose your data" class="form-control" type="text" value="<?php ?>" >
						   </div>
						</div>
						<fieldset disabled>
							<div class="form-group">
								<label for="">Company Address</label>
								<input type="text" name="com_address" required class="form-control" value="<?php echo $com_address?>" id="com_address">
							</div>
							</fieldset>
							<div class="form-group">
